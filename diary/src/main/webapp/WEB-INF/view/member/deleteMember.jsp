                ...
                <div class="col-md-12"> 
					...
					<form method="post" action="${pageContext.servletContext.contextPath}/member/deleteMember">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" class="form-control" value="${deleteMember.memberId}" readonly="readonly" id="memberId" style="width: 100%;" name="memberId">
                        </div>
                        <div class="mb-3">
                       	 ...
                       	 <div>
                            <button type="submit" class="btn btn-dark btn-block">탈퇴</button>
                        </div>
					</form>	
                </div>
            </div>
